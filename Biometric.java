...
public class Biometric {
    ...
    public static void run() {
        ...
        while (again) {
            ...
            System.out.println("Enter [KH] for Key Hold or [Int] for Interval to get FRR and FAR scores.");
            System.out.println("Enter [Other] for more options or [Exit] to quit.");
            System.out.print("> ");
            option = kb.nextLine();
            ...
            switch (option.toLowerCase()) {
                ...
                case "other":
                    while (again2) {
                        ...
                        System.out.println("[1] Display Key Hold values for a user.");
                        System.out.println("[2] Display Interval values for a user.");
                        System.out.println("[3] Display Genuine Scores for a user.");
                        System.out.println("[4] Display Imposter Scores for a user.");
